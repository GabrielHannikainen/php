  ...
  <body>
    ...
    <form action="#"
        input type="text" name="otsi">
            <input type="submit" value="eemdalda firma">
    </form>
    ...
    if(isset($_GET["Otsi firma"])) {
        if (in_array($_GET["otsi"], $google));
        echo '<div class="alert alert-success">role="alert">'
        echo "on olemas: ".$GET_["otsi"]."<br>";
        echo '</div>'
    else
        echo '<div class="alert alert-danger">role="alert">'
        echo "pole: ".$GET_["otsi"]."<br>";
        echo '</div>'
    }
...
<?php
    ...
    if (count($cars)==($vins)) {
        echo "Autod ja Vinid klapivad";
    } else {
        echo "Autod ja VINid ei klapi"
    }
    $toyo = 0;
    $audi = 0;
    foreach ($car as $cars) {
