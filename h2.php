...
<html lang="en">
  ...
  <body>
    ...
    <form action="#" method="get">
        ...
        <input type="submit" name="Otsi_firma" value="eemdalda firma">
    </form>
    ...
    if (isset($_GET["Otsi_firma"])) {
        if (in_array($_GET["otsi"], $google)) {
            echo '<div class="alert alert-success" role="alert">';
            echo "On olemas: ".$_GET["otsi"]."<br>";
            echo '</div>';
        } else {
            echo '<div class="alert alert-danger" role="alert">';
            echo "Pole: ".$_GET["otsi"]."<br>";
            echo '</div>';
        }
    }
    ?>
    ...
    <form action="#" method="get">
        ...
        <input type="submit" name="Eemdalda_firma" value="eemdalda firma">
    </form>
    <br>
    ...
    <h1>Ülesanne 5</h1>
    <?php
    $nimed = array('mari', 'kati', 'malle', 'karin', 'anette', 'kerli', 'liisa', 'minni');
    sort($nimed);
    $loendur = 0; 
    ...
    "3D7TT2HT1AG96429",     "5GADX23L96D250838", "5FRYD3H25FB985936", "1G4GG5E30DF126304", "KNADH5A38B6072755", "WAUBFAFL1BA477979", 
    ...
    "1FTEW1CW4AF371278", "JN1AZ4EH8DM531691", "WAUEKAFBXAN294295");

    echo "Autosid: " . count($cars) . "<br>";
    echo "VINe: " . count($vins) . "<br>";
